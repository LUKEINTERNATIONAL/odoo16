...

{
    'name': 'Requisition',
    'version': '1.2',
    'category': 'Requisition/Requisition',
    'summary': 'Requisition internal machinery',
    'description': """
This module contains all the common features of Requisition Management and eCommerce.
    """,
    'depends': [
        'sales_team',
